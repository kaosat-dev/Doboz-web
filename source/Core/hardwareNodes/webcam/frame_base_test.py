...
class JustATest(Thread):
    ...
    def on_message(self, bus, message):
        try:
           # self.logger.info("Recieved message %s",str(message))
            t = message.type
           # self.logger.info("Message type %s STATE %s" ,str(t),str(self.player.get_state()))
            ...
            if t == gst.MESSAGE_EOS:
                ...
                self.logger.info("Recieved error message")
